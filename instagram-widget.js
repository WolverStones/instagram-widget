...
document.addEventListener("DOMContentLoaded", () => {
    ...
    container.innerHTML = `
        <div id="profile-container" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; padding: 20px; background: white; border-radius: 15px; box-shadow: 0px 4px 12px rgba(0,0,0,0.1); max-width: 1000px; margin: auto;">
            <div style="display: flex; align-items: center; flex: 1 1 250px;">
                ...
                <div style="margin-left: 15px;">
                    <h1 style="font-weight: bold; font-size: 20px; margin: 0;">Nart dance school</h1>
                    <p style="font-size: 16px; color: gray; margin: 0;">@nartdanceschool</p>
                </div>
            </div>
            <div style="display: flex; flex: 1 1 250px; gap: 15px; text-align: center; font-size: 16px; justify-content: flex-end;">
                <div>
